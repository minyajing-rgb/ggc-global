...
[Joyce Mi / GGC — Global PR Status](GLOBAL_PR_STATUS.md): awards, speaking and editorial pipeline across five tracks. Prepared, submitted and accepted opportunities are kept distinct.

## Joyce positioning and client development

- [Joyce persona and evidence](positioning/JOYCE_PERSONA.md)
- [GGC annual-client development skill](skills/ggc-annual-client-development/SKILL.md)
