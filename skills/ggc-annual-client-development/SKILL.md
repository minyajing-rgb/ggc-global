...
只开发华人自研甲方：有自己控制的游戏/IP/产品、缺内部发行团队或明确在自建自发行能力，且与 Casino、Arcade、Sims、AI 身心灵之一相关。中腰部公司与垂类头部优先，核预算和负责人；单纯有产品或流水不能替代发行能力缺口的证据。不能确认甲方身份和缺口时只研究，不发送。第三方服务商一个也不开发。
...
1. 必须核实华人自研甲方、自有产品/IP、四个核心品类、缺发行团队或自建发行的证据，以及与 Joyce 经验的对应。纯代理/外包/渠道立即排除。
...
先通过甲方身份、自研产品、华人团队、核心品类、发行缺口五个硬门槛，再对触发、决策权、支付能力、时效性和证据质量评分。任一硬门槛未核实则不得发送或计合格买方；明确拒绝、无需求或不在采购窗口进入公司级 HOLD/STOP。
